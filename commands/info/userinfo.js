...
module.exports = {
    ...
    async execute(message, args) {
        ...
        try {
            ...
            const connectedAccounts = profileData.connected_accounts.length > 0
                ? profileData.connected_accounts.map(account => `${account.type}: \`${account.name}\``).join('\n')
                : 'None';
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Banner', value: bannerUrl !== 'None' ? `[Link](${bannerUrl})` : 'None', inline: true },
